(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__226c3612._.js",
...
"[project]/apps/workspace/middleware.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function middleware(request) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$shared$2f$src$2f$auth$2f$access$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["canAccessApp"])(role, "workspace")) {
        if (isLoginPage) return response;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(LOGIN_PATH, request.url));
    }
    if (role === "superadmin") {
        ...
        if (isLoginPage) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/", request.url));
        return response;
    }
    const { data: workspace } = await supabase.from("workspaces").select("disabled").eq("user_id", user.id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__226c3612._.js.map